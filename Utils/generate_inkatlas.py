...
def get_source_dir_and_pngs():
    ...
    while True:
        icon_folder = "C:\\Users\\x\\Desktop\\CustomWallpapers\\temp\\images"
...
def get_output_dir():
    ...
    while True:
        output_folder = "C:\\Users\\x\\Desktop\\CustomWallpapers\\temp\\raw\\base\\customwallpapers"
        # Check for quotes which will break the input path
